    ...
    <div class="container container-md">
        ...
        <table class="table table-bordered">
            ...
            <tbody class="table-group-divider">
                ...
                LEFT JOIN user u2 ON r.user_id = u2.id WHERE status = 'Pending'
                UNION DISTINCT
                ...
                LEFT JOIN user u2 ON n.user_id = u2.id WHERE status = 'Pending') ORDER BY post_date_time DESC";
